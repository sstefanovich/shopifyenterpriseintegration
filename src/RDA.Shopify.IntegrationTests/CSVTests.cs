...
namespace RDA.Shopify.IntegrationTests
{
    ...
    {
        [TestMethod]
        public void CSV_Build_Variants_No_Inventory_Test()
        {
        ...
        [TestMethod]
        public void CSV_Build_Variants_Inventory_Test()
        {
            var inventory = new ProductInventory();
            var converter = new ShopifyCSVConverter();
        ...
        [TestMethod]
        public void CSV_Build_No_Variants_No_InventoryTest()
        {
            var inventory = new ProductInventory();
            var converter = new ShopifyCSVConverter();
        ...
        [TestMethod]
        public void CSV_Build_No_Variants_InventoryTest()
        {
            var inventory = new ProductInventory();
            var converter = new ShopifyCSVConverter();
